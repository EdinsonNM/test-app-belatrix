...
var Servicio = (function () {
    ...
    Servicio.prototype.read = function (useAdvance) {
        if (useAdvance === void 0) { useAdvance = false; }
        var r = this.validateFormat(this.texto);
        if (r.success) {
            var rows = (useAdvance) ? this.getRowsAdvance(this.texto) : this.getRows(this.texto);
    ...
    Servicio.prototype.getRows = function (data) {
        var texto = data;
    ...
    Servicio.prototype.getRowsAdvance = function (data) {
    ...
    Servicio.prototype.getDepartamentos = function () {
        var _this = this;
        var data = Object.keys(this.data.departamentos).map(function (e) {
            var data = _this.data.departamentos[e];
            data.idpadre = "-";
            data.padre = "-";
            return data;
        });
    ...
    Servicio.prototype.getProvincias = function () {
        var _this = this;
        var results = [];
        Object.keys(this.data.departamentos).forEach(function (dpto) {
            if (_this.data.provincias.hasOwnProperty(dpto)) {
                Object.keys(_this.data.provincias[dpto]).forEach(function (prv) {
                    var data = _this.data.provincias[dpto][prv];
                    data.idpadre = _this.data.departamentos[dpto].id;
                    data.padre = _this.data.departamentos[dpto].title;
                    results.push(data);
                });
            }
        });
    ...
    Servicio.prototype.getDistritos = function () {
        var _this = this;
        var results = [];
        Object.keys(this.data.departamentos).forEach(function (dpto) {
            if (_this.data.provincias.hasOwnProperty(dpto))
                Object.keys(_this.data.provincias[dpto]).forEach(function (prv) {
                    if (_this.data.distritos.hasOwnProperty(prv))
                        Object.keys(_this.data.distritos[prv]).forEach(function (dist) {
                            var data = _this.data.distritos[prv][dist];
                            data.idpadre = _this.data.provincias[dpto][prv].id;
                            data.padre = _this.data.provincias[dpto][prv].title;
                            results.push(data);
                        });
                });
        });
...
Object.defineProperty(exports, "__esModule", { value: true });
var servicio_class_1 = __webpack_require__(2);
var _ = __webpack_require__(3);
var data = __webpack_require__(0);
var resultsTemplate = __webpack_require__(1);
...
document.querySelector("#btnParse").addEventListener('click', function () {
    ...
    var service = new servicio_class_1.Servicio(data);
    var obj = service.read(true);
